...
usage! {
	...
	}
	{
		...
		["Operating Options"]
			...
			ARG arg_chain: (String) = "etg", or |c: &Config| c.parity.as_ref()?.chain.clone(),
			"--chain=[CHAIN]",
			"Specify the blockchain type. CHAIN may be either a JSON chain specification file or ethereum, classic, etg, xdai, volta, ewc, musicoin, ete, ellaism, mix, callisto, morden, mordor, ropsten, kovan, rinkeby, goerli, kotti, poasokol, testnet, or dev.",
