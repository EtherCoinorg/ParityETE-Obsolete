...
use shared::*;
use std::io;
//use hash as progpowG;
use progpowG::{create_light_cache, get_block_progpow_hash, get_from_mix};
...
impl Light {
	pub fn new_with_builder(
		...
		let cache = builder.new_cache(cache_dir.to_path_buf(), block_number);
                ...
                let algorithm = if block_number > PROGPOW_START {
...
pub fn quick_get_difficulty(block_number: u64, header_hash: &H256, nonce: u64, mix_hash: &H256, progpow: bool) -> H256 {
	unsafe {
